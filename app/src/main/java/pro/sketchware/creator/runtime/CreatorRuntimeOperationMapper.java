...
public final class CreatorRuntimeOperationMapper {
    ...
    private static Object jsonToValue(JsonElement element) {
        ...
        if (element.isJsonArray()) return jsonArrayToList(element.getAsJsonArray());
    ...
    private static java.util.List<Object> jsonArrayToList(com.google.gson.JsonArray source) {
        java.util.List<Object> result = new ArrayList<>();
        for (JsonElement element : source) result.add(jsonToValue(element));
        return result;
    }
}
