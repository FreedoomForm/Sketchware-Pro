...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_auto_awesome, "AI Agent settings", "Configure AI providers, reasoning effort, auto-approve, and image generation", new ActivityLauncher(new Intent(getApplicationContext(), com.sketchware.ai.ui.settings.AISettingsActivity.class))), true);
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_android, "Versions", "View available Sketchware Pro updates and download the latest APK", new ActivityLauncher(com.sketchware.ai.ui.settings.AISettingsActivity.newIntent(getApplicationContext(), com.sketchware.ai.ui.settings.AISettingsActivity.FRAGMENT_VERSIONS))), true);
